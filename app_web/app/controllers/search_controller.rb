...
class SearchController < ApplicationController
  def show
    ...
    todos_los_episodios=HTTP.get("https://rickandmortyapi.com/api/episode/?name=" + params[:keyword]).parse
    ...
    todos_los_personajes=HTTP.get("https://rickandmortyapi.com/api/character/?name=" + params[:keyword]).parse
